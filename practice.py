...
def find_unique_common_items(items1, items2):
    ...
    **IMPORTANT**: you may not use `'if ___ in ___``
    ...
    different data types::
        ...
        [2]
    """
    unique_items1, unique_items2 = set(items1), set(items2)

    unique_common_items = [item1 for item1 in unique_items1 for item2 in
                           unique_items2 if item1 == item2]
